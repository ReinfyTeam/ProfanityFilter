...
echo =================================================================== > "actions.log"
echo As of $(date +"%d-%m-%Y %T.%N %Z") report data from actions > "actions.log"
echo "" > "actions.log"
echo Action Exit Code: $? > "actions.log"
echo Time Success: $(date +%T.%N %Z) > "actions.log"
echo =================================================================== > "actions.log"
...
echo =================================================================== > "actions.log"
echo As of $(date +"%d-%m-%Y), Here's what files are included in actions.
