...
class ConfigManager {
	...
	public function profanityGet(string|array $k) :string|array {
		$instance = new Config($this->getDataFolder() . "/banned-words.yml", Config::YAML);
		return $instance->get($k);
	}
	public function profanitySet(string|array $k, array $v) :mixed {
		$instance = new Config($this->getDataFolder() . "/banned-words.yml", Config::YAML);
		return $instance->set($k, array($v));
	}
