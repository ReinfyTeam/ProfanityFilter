...
use ReinfyTeam\ProfanityFilter\libs\_a78acd1e7b2b6d62\CortexPE\Commando\args\RawStringArgument;
use pocketmine\command\CommandSender;
use ReinfyTeam\ProfanityFilter\Utils\PluginUtils;
use function is_string;

class RemoveWordSubCommand extends BaseProfanitySubCommand {
	...
	public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void {
		...
		PluginUtils::removeProfanityWord($args[self::ARG_WORD]);
