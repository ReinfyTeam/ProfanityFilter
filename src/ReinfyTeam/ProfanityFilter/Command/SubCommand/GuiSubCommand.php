...
use ReinfyTeam\ProfanityFilter\libs\_eafedc926e03859c\dktapps\pmforms\CustomForm as PmCustomForm;
use ReinfyTeam\ProfanityFilter\libs\_eafedc926e03859c\dktapps\pmforms\element\Input;
use ReinfyTeam\ProfanityFilter\libs\_eafedc926e03859c\dktapps\pmforms\element\Label;
use ReinfyTeam\ProfanityFilter\libs\_eafedc926e03859c\dktapps\pmforms\MenuForm;
use ReinfyTeam\ProfanityFilter\libs\_eafedc926e03859c\dktapps\pmforms\MenuOption;
...
class GuiSubCommand extends BaseProfanitySubCommand {
	...
	private function addProfanityWordForm(Player $player, ?string $infoKey = null) : void {
		...
		$form = new PmCustomForm(
			$title,
			$elements,
			function (Player $player, \ReinfyTeam\ProfanityFilter\libs\_eafedc926e03859c\dktapps\pmforms\CustomFormResponse $response) : void {
