...
use ReinfyTeam\ProfanityFilter\libs\_eb3bc1af5bcde7e7\dktapps\pmforms\CustomForm as PmCustomForm;
use ReinfyTeam\ProfanityFilter\libs\_eb3bc1af5bcde7e7\dktapps\pmforms\element\Input;
use ReinfyTeam\ProfanityFilter\libs\_eb3bc1af5bcde7e7\dktapps\pmforms\element\Label;
use ReinfyTeam\ProfanityFilter\libs\_eb3bc1af5bcde7e7\dktapps\pmforms\MenuForm;
use ReinfyTeam\ProfanityFilter\libs\_eb3bc1af5bcde7e7\dktapps\pmforms\MenuOption;
...
class GuiSubCommand extends BaseProfanitySubCommand {
	...
	private function addProfanityWordForm(Player $player, ?string $infoKey = null) : void {
		...
		$form = new PmCustomForm(
			$title,
			$elements,
			function (Player $player, \ReinfyTeam\ProfanityFilter\libs\_eb3bc1af5bcde7e7\dktapps\pmforms\CustomFormResponse $response) : void {
