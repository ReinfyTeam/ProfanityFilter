...
use ReinfyTeam\ProfanityFilter\libs\_f4fbcdfc4cce84bc\dktapps\pmforms\CustomForm as PmCustomForm;
use ReinfyTeam\ProfanityFilter\libs\_f4fbcdfc4cce84bc\dktapps\pmforms\element\Input;
use ReinfyTeam\ProfanityFilter\libs\_f4fbcdfc4cce84bc\dktapps\pmforms\element\Label;
use ReinfyTeam\ProfanityFilter\libs\_f4fbcdfc4cce84bc\dktapps\pmforms\MenuForm;
use ReinfyTeam\ProfanityFilter\libs\_f4fbcdfc4cce84bc\dktapps\pmforms\MenuOption;
...
class GuiSubCommand extends BaseProfanitySubCommand {
	...
	private function addProfanityWordForm(Player $player, ?string $infoKey = null) : void {
		...
		$form = new PmCustomForm(
			$title,
			$elements,
			function (Player $player, \ReinfyTeam\ProfanityFilter\libs\_f4fbcdfc4cce84bc\dktapps\pmforms\CustomFormResponse $response) : void {
